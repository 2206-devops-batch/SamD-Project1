...
def main():
        ...
        if args.argument1:     #if there is an argument set
            ...
            print(f"pQount(line12): {polyhedral_count}")
        else:
        ...
        if data_row[0][1] == str(polyhedral_count):
            print(f"loaded:  {data_row}")   #took out [0]
            working_data_row=list(map(int, data_row[0][2:])) #[2:]strip the datime and poly and int it 
            print(f"workingDateRow test21: {working_data_row}")
            print(f"(line23)data_row: {data_row}")
            ...
            print(f"(line30)data_row: {data_row}")
        ...
        print(f"file_data_row(line34): {file_data_row}")
        ...
        if data_row[0][1] == str(polyhedral_count):
            ...
            print(f"(line47/52)data_row: {data_row}")
        ...
        print(f"file_data_row: {file_data_row}")
